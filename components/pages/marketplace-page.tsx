...
export function MarketplacePage({ onPageChange }: MarketplacePageProps) {
  const [activeTab, setActiveTab] = useState<'projects' | 'developers' | 'analytics'>('projects');
        ...
        <div className="nexus-card">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <select 
              ...
              className="bg-white/10 border border-cyan-500/30 rounded-lg px-3 py-2 text-white outline-none focus:border-cyan-400"
            >
            ...
            <select className="bg-white/10 border border-cyan-500/30 rounded-lg px-3 py-2 text-white outline-none focus:border-cyan-400">
