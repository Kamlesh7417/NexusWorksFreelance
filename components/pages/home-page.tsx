  ...
  return (
    <div className="space-y-24">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container relative">
          <div className="text-center max-w-5xl mx-auto">
            <h1 className="text-gradient mb-8 animate-fade-in">
      ...
      <section className="py-16">
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="text-gradient mb-6">Quantum-Powered Features</h2>
      ...
      <section className="py-16">
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="text-gradient mb-6">Future Technologies</h2>
            <p className="text-xl max-w-3xl mx-auto">
      ...
      <section className="py-16">
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="text-gradient mb-6">How NexusWorks Works</h2>
            <p className="text-xl max-w-3xl mx-auto">
