    ...
    <div className="flex flex-col gap-4 animate-pulse">
      ...
      <div className="flex justify-end">
        <div className="max-w-[80%] bg-cyan-500/20 rounded-tl-lg rounded-tr-lg rounded-bl-lg p-3">
          ...
          <div className="w-24 h-3 bg-white/10 rounded ml-auto"></div>
        </div>
      </div>
      <div className="flex justify-start">
        <div className="max-w-[80%] bg-white/10 rounded-tr-lg rounded-tl-lg rounded-br-lg p-3">
  ...
  return (
    <div className="space-y-8 animate-pulse">
      <div className="flex items-center justify-between mb-8">
        <div>
          <div className="w-48 h-8 bg-white/10 rounded mb-2"></div>
        ...
        {Array.from({ length: 4 }).map((_, index) => (
          <div key={index} className="bg-white/5 rounded-lg p-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <div className="w-24 h-5 bg-white/10 rounded mb-1"></div>
